...
?>
<?php
    $sql="select * from recipe where category='VEG' and festivalCheck='n'";
...
<section class="imgVegR">
    <div class="row">
         <img src="images/vegBanner.jpg" alt="Veg Banner" class="responsive-img">
    </div>
</section>
<section class="vegRecContSec" data-aos="fade-up" data-aos-duration="1000">
    <div class="container center">
        <div class="divOpa">
        <h2 class="center Poppins-SemiBold">

        VEG RECIPES</h2>
        <p class="">Welcome to Veg recipes of Noida. This is a recipe website on vegetarian recipes from the Indian state of Uttar Pradesh.</p>
        </div>
    </div>
</section>
<section class="vegRecBoxSec" data-aos="fade-up" data-aos-duration="1000">
<div class="container">
