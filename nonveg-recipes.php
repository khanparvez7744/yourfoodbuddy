...
?>
<?php
    $sql="select * from recipe where category='NONVEG' and festivalCheck='n'";
...
<section class="imgNon">
    <div class="row">
         <img src="images/nonvegBanner.jpg" alt="Nonveg Banner" class="responsive-img">
    </div>
</section>
<section class="nonvegRecContSec" data-aos="fade-up" data-aos-duration="1000">
    <div class="container center">
        <div class="divOpa">
        <h2 class="center Poppins-SemiBold">

        NONVEG RECIPES</h2>
        <p class="">Non Vegetarian Cuisine is very vast and spreads across the all regions in India. Each region have their specific taste and spices that go into making the non vegetarian food.</p>
        </div>
    </div>
</section>
<section class="nonvegRecBoxSec" data-aos="fade-up" data-aos-duration="1000">
<div class="container">
