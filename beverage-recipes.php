...
?>
<?php
    $sql="select * from recipe where category='BEVERAGES' and festivalCheck='n'";
...
<section class="imgBever">
    <div class="row">
         <img src="images/beverageBanner.jpg" alt="Beverage Banner" class="responsive-img">
    </div>
</section>
<section class="beverageRecContSec" data-aos="fade-up" data-aos-duration="1000">
    <div class="container center">
        <div class="divOpa">
        <h2 class="center Poppins-SemiBold">BEVERAGES</h2>
        <p class="">The wide world of delicious and refreshing beverages is vast. This section is dedicated to all of the sippable libations that I love.</p>
        </div>
    </div>
</section>
<section class="beverageRecBoxSec" data-aos="fade-up" data-aos-duration="1000">
    <div class="container">
